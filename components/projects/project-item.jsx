function ProjectItem(props) {
    return (
        <a href={props.href} target="_blank" rel="noopener noreferrer" className="group flex flex-col p-5 transition-all bg-primary-100 hover:z-10 hover:scale-110 brightness-75 hover:brightness-100">
