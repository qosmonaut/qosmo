function ProjectItem(props) {
    return (
        <a href={props.href} target="_blank" rel="noopener noreferrer" className="group bg-primary-100 flex flex-col p-5 brightness-75 transition-all hover:z-10 hover:scale-110 hover:brightness-100">
