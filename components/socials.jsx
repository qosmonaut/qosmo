...
const Socials = (props) => {
    return (
        <div className='flex flex-row items-center justify-center gap-8 lg:justify-start'>
            <a href={`mailto:${props.data.email}`} className='bg-primary-300 hover:bg-primary-200 text-primary-50 flex flex-row items-center justify-center rounded px-4 py-2 font-bold transition-all'>
